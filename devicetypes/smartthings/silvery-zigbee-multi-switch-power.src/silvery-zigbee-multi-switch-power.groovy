...
metadata {
	definition(name: "Silvery ZigBee Multi Switch Power", namespace: "smartthings", author: "VadimFinkel", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings", vid: "generic-switch-power") {
		capability "Actuator"
        ...
        fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0019, 000A", manufacturer: "_TZ3000_1obwwnmq", model: "TS011F", deviceJoinName: "Silvery SwitchPower Tree Socket" //Silvery SMART TREE SOCKET 1
	}
